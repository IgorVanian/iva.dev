...
const Tools = [{
  ...
  comment: "On commence à se connaître depuis un paquet d'années avec le p'tiot. Je dois admettre qu'il se débrouille, mais s'il arrêtait de toujours se reposer sur le JS pour ses animations, il n'aurait peut-être pas de cheveux blancs à 27 ans!",
  ...
  comment: "J'ai rencontré Igor à une soirée un peu bizarre, il m'a paru assez ouvert d'esprit, j'ai aimé échanger quelques mots avec lui. J'espère qu'on se recroisera au plus vite!!!",
  dateAgo: 'il y a 1 an',
  image: 'ts'
}, {
  title: 'NodeJS',
  ...
  comment: "7/10, c'est bien payé. Le mec débarque quand ça lui chante, n'en fait qu'à sa tête, soit disant qu'il \"n'a pas le temps\" et rebelote pour la prochaine ! La programmation réactive Igor, c'est pour 2050?!?",
  ...
  comment: "Chic type, toujours partant pour déconner, pas spécialement rapide à la détente, mais efficace! Ne baisse pas les bras !",
  ...
  comment: "Se dit être un pote alors qu'il n'a pas encore enregistré mon nouveau numéro ! Puis niveau ménage, vous auriez vu son appart. Bon, il avait tellement de bordel à ranger, sous pression, il a trié n'importe comment. Prends ton temps, on t'a dit plein de fois!!",
  dateAgo: 'il y a 5 ans',
  image: 'reactNative'
}, {
  title: 'SQL/NoSQL',
  ...
  comment: "Avec tous ses nouveaux amis, ça fait un bail que je ne l'ai pas revu. Mais je suis sûr qu'il se souvient de moi. On a une bonne mémoire nous deux ! Repasse quand tu veux !",
  ...
  comment: "Un jour, il m'a annoncé qu'il éprouvait un dégoût profond envers moi, comme ça, gratos, sans raison...",
  dateAgo: 'il y a 10 ans',
  image: 'php'
}, {
  title: 'Python',
